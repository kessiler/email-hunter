...
EmailHunter.prototype.callAPI = function (type, attr, callback) {
 ...
 */
EmailHunter.prototype.emailVerifier = function (options, callback) {
  return this.callAPI('email-verifier', options, callback);
};
...
EmailHunter.prototype.emailCount = function (domain, callback) {
  return this.callAPI('email-count', {
    domain
  }, callback);
};
